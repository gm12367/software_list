...
cat test.txt|awk '{for(i=20;i<=NF;i++){print $i;}}'|awk NR%3==1 > array1.txt
cat test.txt|awk '{for(i=20;i<=NF;i++){print $i;}}'|awk NR%3==2 > array2.txt
cat test.txt|awk '{for(i=20;i<=NF;i++){print $i;}}'|awk NR%3==0 > array3.txt
